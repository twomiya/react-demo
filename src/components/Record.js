...
class Record extends Component {
    ...
    recordRow(){
        return(
            <tr>
            {/* 一<td>{this.props.record.date}</td>
            <td>{this.props.record.title}</td>
            <td>{this.props.record.amount}</td> */}
            {/* 二<td>{this.props.date}</td>
            ...
            <td>
                ...
                <button className="btn btn-danger" onClick={this.handeleDelete.bind(this)}>delete</button>
            </td>
        </tr>  
        )
    }
    recordForm(){
        return(
            ...
            <td>{this.props.record.title}</td>
            <td>{this.props.record.amount}</td> */}
            {/* 二<td> <input type="text" className="form-control"  defaultValue={this.props.date} ref="date" /></td>
            ...
            <td>
                <button className="btn btn-info mr-1" onClick={this.handeleEdit.bind(this)}>Update</button>
